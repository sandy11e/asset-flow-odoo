...
const MeetingRoomBookingPage = () => {
  ...
  // Filter strictly for Meeting Room
  const roomBookings = filterBookings(bookings, {
    query: searchQuery,
    status: statusFilter,
    resourceType: 'Meeting Room',
  });

  const roomResources = resources.filter((r) => r.type === 'Meeting Room');

  return (
    <div className="space-y-6 animate-in fade-in-50 duration-200">
      <PageHeader
        title="Meeting & Conference Room Reservations"
        subtitle="Manage executive board rooms, video conference suites, and team breakout spaces across all campus hubs."
        breadcrumbs={[
      ...
      <div className="p-4 bg-white dark:bg-sidebar-hover rounded-2xl border border-gray-200 dark:border-gray-700 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xs">
        <div className="flex items-center gap-2 w-full md:w-auto">
          <BookingSearch
            ...
            placeholder="Search meeting rooms, attendees, ID..."
          />
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          ...
          <div className="flex items-center bg-gray-100 dark:bg-sidebar-bg p-1 rounded-xl border border-gray-200 dark:border-gray-700 shrink-0">
            ...
            <button
              ...
              title="Room Availability Schedule"
            >
      ...
      {viewMode === 'availability' ? (
        <CalendarScheduleTable resources={roomResources} isLoading={isLoading} />
      ) : viewMode === 'table' ? (
        <BookingTable
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {roomBookings.length === 0 && !isLoading && (
            <div className="col-span-full p-12 text-center text-gray-400 bg-white dark:bg-sidebar-hover rounded-xl border border-gray-200 dark:border-gray-700">
              No meeting room reservations found matching your criteria.
            </div>
          )}
        </div>
      )}
      ...
      <CreateBookingDialog
        ...
        initialResourceType="Meeting Room"
